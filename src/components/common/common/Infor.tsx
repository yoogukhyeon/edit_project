...
const Infor = ({ text, setValue }: IProps) => {
  const onClickClose = () => {
    setValue(false);
  };

  return (
    <div id="alert-1" className="flex items-center p-3 my-2 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
