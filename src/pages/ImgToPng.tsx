...
const ImgToPng = () => {
  ...
  return (
    <div className="w-full">
      ...
      />
      <h1 className="mb-3 text-lg font-medium text-gray-900 dark:text-white">이미지 PNG 변환</h1>
      {loading ? (
        <Loading />
      ) : (
        <>
      ...
      <SEOContent page="imgToPng" />
      <Comment pathname="imgToPng" />
    </div>
  );
};

export default ImgToPng;
